...
useEffect(()=>{
  ...
  return (
    <Row className="container m-auto my-5">
      ...
      <Col md={6} lg={6} className="mb-3">
        <Card className="h-100 text-center opacity-75">
          <Card.Body>
            <Card.Title className="primary-font">{receta.nombreReceta}</Card.Title>
            <p className="text-secondary-emphasis fw-bold">{receta.categoria}</p>
            <h5>Ingredientes</h5>
            <Card.Text className="text-warning-emphasis fw-bold">
              {receta.ingredientes}
               </Card.Text>
              <h5>Preparación</h5>
              <Card.Text className="text-info-emphasis fw-bold">
              {receta.preparacion}
            </Card.Text>
          </Card.Body>
        </Card>
